...
local AimFloatingBtn = Instance.new("TextButton")
AimFloatingBtn.Size = UDim2.new(0, 120, 0, 40)
AimFloatingBtn.Position = UDim2.new(0, 20, 0, 100)
AimFloatingBtn.Text = "AIM: OFF"
AimFloatingBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
AimFloatingBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
AimFloatingBtn.Font = Enum.Font.SourceSansBold
AimFloatingBtn.TextSize = 14
AimFloatingBtn.ZIndex = 20
AimFloatingBtn.Active = true
AimFloatingBtn.Draggable = true
AimFloatingBtn.Parent = ScreenGui

local AimCorner = Instance.new("UICorner")
AimCorner.CornerRadius = UDim.new(0, 6)
AimCorner.Parent = AimFloatingBtn

local function UpdateAimState(state)
    Settings.Aimbot = state
    if Settings.Aimbot then
        AimFloatingBtn.Text = "AIM: ON"
        AimFloatingBtn.BackgroundColor3 = Color3.fromRGB(40, 150, 40)
        if AimBtnMenuRef then
            AimBtnMenuRef.Text = "Aimbot: ON"
            AimBtnMenuRef.TextColor3 = Color3.fromRGB(100, 255, 100)
        end
    else
        AimFloatingBtn.Text = "AIM: OFF"
        AimFloatingBtn.BackgroundColor3 = Color3.fromRGB(40, 40, 40)
        if AimBtnMenuRef then
            AimBtnMenuRef.Text = "Aimbot: OFF"
            AimBtnMenuRef.TextColor3 = Color3.fromRGB(200, 200, 200)
        end
    end
end

AimFloatingBtn.MouseButton1Click:Connect(function()
    UpdateAimState(not Settings.Aimbot)
end)
...
AimBtnMenuRef = AddToggle(ImportantScroll, "Aimbot", "Aimbot", function(state) end)
