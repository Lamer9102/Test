...
local b2 = AddTextBox(toolGroup, "Sword Killaura Range", function(text)
...
local r2 = AddTextBox(redGroup, "TP Delay", function(text)
   local n = tonumber(text)
...
local o1 = AddTextBox(orangeGroup, "ID", function(text)
...
local p2 = AddTextBox(purpleGroup, "Platform Y offset", function(text)
   local n = tonumber(text)
   if n then
